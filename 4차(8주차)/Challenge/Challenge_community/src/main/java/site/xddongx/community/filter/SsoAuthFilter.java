...
import static site.xddongx.community.filter.LikelionSsoConsts.LIKELION_LOGIN_COOKIE;
...
public class SsoAuthFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if(authToken.isPresent()) {
            ...
            logger.info("Login Toke Missing");
    ...
    private Optional<String> authTokenFromQuery(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws IOException {
