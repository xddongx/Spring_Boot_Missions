...
public class AmqpLogoutPublisher implements LogoutPublisherService {
    ...
    public AmqpLogoutPublisher(RabbitTemplate rabbitTemplate, FanoutExchange fanoutExchange) {
    ...
    public void publishLogoutEvent(String cookieValue) {
        ...
        rabbitTemplate.convertAndSend(fanoutExchange.getName(), "", cookieValue);
    }
}
